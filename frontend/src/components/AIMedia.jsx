...
const AIMedia = () => {
  ...
  const modules = [
    ...
    { id: 'control', title: '四、OpenClaw 控制终端', icon: Terminal, color: 'text-purple-400', bg: 'bg-purple-500/10' },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-purple-500/30 font-sans antialiased">
      ...
      {/* 1. Hero Section - Simple & Atmospheric */}
      ...
      {/* 2. Sticky Switcher - Larger Font */}
      <div className="sticky top-24 z-50 bg-black/90 backdrop-blur-xl border-b border-white/10 shadow-2xl">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-24">
            <div className="flex flex-1 justify-center lg:justify-start gap-4 md:gap-10 overflow-x-auto no-scrollbar">
              {modules.map((m, i) => (
                <button 
                  key={m.id}
                ...
                >
                  ...
                  {activeTab === m.id && (
                    <div className={`absolute bottom-0 left-0 w-full h-1 ${m.color.replace('text', 'bg')} shadow-[0_0_20px_rgba(255,255,255,0.1)]`} />
                  )}
                </button>
              ))}
            </div>
      ...
      {/* 3. Detailed Modules - Clear & Generous Layout */}
          ...
          <div className="grid lg:grid-cols-12 gap-20 items-start">
            <div className="lg:col-span-7">
              ...
              <div className="space-y-12">
                <div className="p-8 rounded-[3rem] bg-white/[0.03] border border-white/5">
                  ...
                  <div className="grid md:grid-cols-3 gap-8 text-base leading-relaxed text-slate-400">
                    <div className="space-y-3">
                       <div className="font-bold text-white text-lg">懂垂直领域需求</div>
                       <p>洞察 AI 编程、自媒体运营、跨境电商等垂直领域经纪人的核心痛点。</p>
                    </div>
                    <div className="space-y-3">
                       <div className="font-bold text-white text-lg">懂话题火爆逻辑</div>
                       <p>识别具有争议性、实用性、情绪共鸣的话题，确保文案不自嗨。</p>
                    </div>
                    <div className="space-y-3">
                       <div className="font-bold text-white text-lg">懂平台推送差异</div>
                       <p>区分公众号深度文、小红书种草、抖音娱乐等不同平台的调性。</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
                  <p>
                    如果你没有热点敏感度，AI 只会帮你生产 <span className="text-white font-bold italic underline decoration-red-500">“没人看的内容”</span>。
                  </p>
            ...
            <div className="lg:col-span-5 pt-20 lg:pt-0">
              <div className="bg-[#0A0A0A] rounded-[3rem] border border-white/10 p-10 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 p-8 opacity-10"><Activity className="w-24 h-24 text-red-500" /></div>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-16">
            <div className="p-10 rounded-[3.5rem] bg-white/[0.03] border border-white/10 group hover:border-orange-500/30 transition-all">
              <div className="flex items-center space-x-5 mb-8">
                <div className="w-14 h-14 rounded-2xl bg-orange-500/10 flex items-center justify-center text-orange-400"><Hash className="w-8 h-8" /></div>
                <h3 className="text-2xl font-bold italic text-white">文章类：公众号、图文、知乎</h3>
              </div>
              <p className="text-base text-slate-400 leading-relaxed mb-6">适用于发布公众号文章/图文、知乎文章、小红书图文。在确定主题后，AI 自动匹配写作素材、进行排版优化、自动生成封面图及配图，形成完整文案。</p>
            </div>
            <div className="p-10 rounded-[3.5rem] bg-white/[0.03] border border-white/10 group hover:border-blue-500/30 transition-all">
              <div className="flex items-center space-x-5 mb-8">
                <div className="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-400"><Video className="w-8 h-8" /></div>
                <h3 className="text-2xl font-bold italic text-white">视频类：视频号、抖音</h3>
              </div>
              <p className="text-base text-slate-400 leading-relaxed mb-6">核心在于“创意系统”的故事编排，通过内置的数字人类视频、动画视频制作、分镜场景故事制作，将枯燥文案转化为极具表现力的剧情、短剧或漫画动画系列。</p>
            </div>
          </div>
          ...
          <div className="p-12 md:p-16 rounded-[4rem] bg-gradient-to-br from-white/[0.04] to-transparent border border-white/10 relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-20">
              ...
              <div className="p-10 rounded-[3.5rem] bg-white/[0.03] border border-white/10 relative">
                 <div className="text-lg font-black text-blue-400 uppercase tracking-widest mb-8 italic">03. 1000 个港险精选案例 (真实法律场景)</div>
        ...
        <section ref={systemRefs.control} className="scroll-mt-48">
          <div className="grid lg:grid-cols-12 gap-20 items-center">
             <div className="lg:col-span-7">
                ...
                <h2 className="text-4xl md:text-5xl font-black mb-10 tracking-tight italic">四、OpenClaw 控制系统</h2>
                ...
                <div className="bg-[#020202] rounded-[2.5rem] border border-white/5 p-10 font-mono text-sm text-purple-400/80 mb-12 shadow-2xl">
                   ...
                   <div className="space-y-3">
                      <div className="flex items-center"><span className="mr-4 text-slate-700 font-bold">$</span> openclaw --launch --all-modules</div>
             ...
             <div className="lg:col-span-5 flex flex-col justify-center gap-6">
                ...
                <button className="w-full px-12 py-6 rounded-3xl bg-white/5 border border-white/10 text-white font-black text-lg hover:bg-white/10 transition-all text-center">
                   预约系统演示
                </button>
             </div>
          </div>
